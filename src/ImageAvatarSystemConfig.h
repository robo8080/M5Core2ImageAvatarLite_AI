...
class ImageAvatarSystemConfig {
    protected:
        ...
        String _voicevox_api_key;
        String _stt_api_key;
        uint8_t _tts_speaker_no;
        String _role;
    ...
    public:
        ...
        String getWiFiSSID() { return _wifi_ssid; }
        String getWiFiPass() { return _wifi_pass; }
        String getOpenaiApiKey() { return _openai_api_key; }
        String getVoicevoxApiKey() { return _voicevox_api_key; }
        String getSttApiKey() { return _stt_api_key; }
        String getRole() { return _role; }
        uint8_t getTtsSpeakerNo() { return _tts_speaker_no; }
